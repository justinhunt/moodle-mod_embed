...
use mod_embed\grades\grades AS grades;
...
require_capability('mod/embed:grades', $modulecontext);
...
$gradingmanager = get_grading_manager($modulecontext, 'mod_embed', 'embed');
